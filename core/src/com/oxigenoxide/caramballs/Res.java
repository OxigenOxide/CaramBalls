...
public class Res {
	...
	public static TextureRegion[][] video;
	...
	public static TextureRegion[] tex_particle_jelly_green;
	public static TextureRegion[] tex_particle_jelly_red;
	...
	public static TextureRegion[] tex_farmSpike;
	public static TextureRegion[] tex_farmSpike_hole;
	...
	public static TextureRegion tex_egg;
	public static TextureRegion tex_egg_locked;
	public static TextureRegion tex_eggShop_arrow;
	...
	public static TextureRegion tex_glow;
	public static TextureRegion tex_lifeShop_back;
	public static TextureRegion tex_lifeShop_ball;
	public static TextureRegion tex_atlas;
	public static TextureRegion[] tex_jellyShield;
	public static TextureRegion[] tex_jelly_red;
	public static TextureRegion[] tex_jelly_green;
	public static TextureRegion tex_wheel_empty;
	public static TextureRegion[] tex_tutorialHand;
	public static TextureRegion[] tex_powerOrbBall;
	...
	public static TextureRegion tex_scooper_small;
	public static TextureRegion tex_scooperShine_small;
	...
	public static TextureRegion tex_text_continue;
	...
	public static TextureRegion tex_ballDepot_ball_blue;
	...
	public static TextureRegion tex_ballDepot_frame_blocked;
	public static TextureRegion tex_ballDepot_line;
	public static TextureRegion tex_orbDisplay;
	public static TextureRegion tex_hole_farm;
	public static TextureRegion tex_eggBar;
	public static TextureRegion tex_pixel;
	public static TextureRegion tex_orb_shop;
	public static TextureRegion tex_spikeWall_upper;
	public static TextureRegion tex_spikeWall_lower;
	public static TextureRegion tex_pole_danger;
	public static TextureRegion tex_pole_normal;
	public static TextureRegion tex_pole_orb;
	public static TextureRegion tex_wall;
	public static TextureRegion tex_wheel;
	public static TextureRegion tex_wheel_base;
	public static TextureRegion tex_wheel_arrow;
	public static TextureRegion tex_shadow;
	public static TextureRegion tex_ballSelector_line;
	public static TextureRegion tex_circle_28p;
	public static TextureRegion tex_circle_8p;
	public static TextureRegion tex_circle_7p;
	public static TextureRegion tex_circle_14p;
	public static TextureRegion tex_circle_19p;
	public static TextureRegion tex_circle_12p;
	public static TextureRegion tex_circle_18p;
	public static TextureRegion tex_circle_23p;
	...
	public static ShaderProgram shader_cutCircle;
	...
	public static FixtureDef fixtureDef_cage_corner_0;
	public static FixtureDef fixtureDef_cage_corner_1;
	...
	public static FixtureDef fixtureDef_spikeWall_lower;
	public static FixtureDef fixtureDef_spikeWall_upper;
	public static FixtureDef fixtureDef_gate;
	public static FixtureDef fixtureDef_jellyShield;
	...
	public static Color[][] palette_egg;
	...
	public static Color[] PALETTE_RED = new Color[]{Color.BLACK, Color.RED, Color.RED, Color.RED};
	...
	public static Sound sound_slime_death;
	public static Sound sound_ballBreak;
	public static Sound sound_whoosh_0;
	public static Sound sound_whoosh_1;
	public static Sound sound_eggCrack;
	public static Sound sound_shot;
	public static Sound sound_ballHit_soft;
	...
	public static final short MASK_SPIKEWALL = 0x0004;
	...
	public Res() {
		...
		sound_shield = Main.assets.get("sounds/shield.mp3");
		...
		sound_slime_death = Main.assets.get("sounds/slime_death.mp3");
		sound_ballBreak = Main.assets.get("sounds/ballBreak.mp3");
		sound_whoosh_0 = Main.assets.get("sounds/whoosh_0.mp3");
		sound_whoosh_1 = Main.assets.get("sounds/whoosh_1.mp3");
		sound_eggCrack = Main.assets.get("sounds/eggCrack.mp3");
		sound_shot = Main.assets.get("sounds/shot.mp3");
		sound_ballHit_soft = Main.assets.get("sounds/ballHit_soft.mp3");
		...
		tex_text_continue = atlas.findRegion("text_continue");
		...
		tex_scooper_small = atlas.findRegion("scooper_small");
		tex_scooperShine_small = atlas.findRegion("scooperShine_small");
		...
		tex_ballDepot_ball_blue = atlas.findRegion("ballDepot_ball_blue");
		tex_ballDepot_frame = atlas.findRegion("ballDepot_frame");
		tex_ballDepot_frame_blocked = atlas.findRegion("ballDepot_frame_blocked");
		...
		tex_hole_farm = atlas.findRegion("hole_farm");
		tex_glow = atlas.findRegion("glow");
		tex_egg = atlas.findRegion("egg");
		tex_egg_locked = atlas.findRegion("egg_locked");
		tex_eggBar = atlas.findRegion("eggBar");
		tex_pixel = atlas.findRegion("pixel");
		tex_eggShop_arrow = atlas.findRegion("eggShop_arrow");
		tex_orb_shop = atlas.findRegion("orb_shop");
		tex_lifeShop_back = atlas.findRegion("lifeShop_back");
		tex_lifeShop_ball = atlas.findRegion("lifeShop_ball");
		tex_spikeWall_upper = atlas.findRegion("spikeWall_upper");
		tex_spikeWall_lower = atlas.findRegion("spikeWall_lower");
		tex_pole_danger = atlas.findRegion("pole_danger");
		tex_pole_normal = atlas.findRegion("pole_normal");
		tex_pole_orb = atlas.findRegion("pole_orb");
		tex_wall = atlas.findRegion("wall");
		tex_wheel = atlas.findRegion("wheel");
		tex_wheel_base = atlas.findRegion("wheel_base");
		tex_wheel_arrow = atlas.findRegion("wheel_arrow");
		tex_wheel_empty = atlas.findRegion("wheel_empty");
		tex_shadow = atlas.findRegion("shadow");
		tex_ballSelector_line = atlas.findRegion("ballSelector_line");
		tex_circle_28p = atlas.findRegion("circle_28p");
		tex_circle_19p = atlas.findRegion("circle_19p");
		tex_circle_14p = atlas.findRegion("circle_14p");
		tex_circle_8p = atlas.findRegion("circle_8p");
		tex_circle_7p = atlas.findRegion("circle_7p");
		tex_circle_12p = atlas.findRegion("circle_12p");
		tex_circle_18p = atlas.findRegion("circle_18p");
		tex_circle_23p = atlas.findRegion("circle_23p");

		tex_jelly_green = atlas.findRegions("jelly_green").toArray();
		tex_jelly_red = atlas.findRegions("jelly_red").toArray();
		tex_jellyShield = atlas.findRegions("jellyShield").toArray();
		...
		tex_spike = new TextureRegion[]{
				...
				atlas.findRegion("spike", 5),
				atlas.findRegion("spike", 6),
				atlas.findRegion("spike", 7),
				atlas.findRegion("spike", 8),
				atlas.findRegion("spike", 9),
		};
		...
		tex_particle_jelly_green = atlas.findRegions("particle_jelly_green").toArray();
		tex_particle_jelly_red = atlas.findRegions("particle_jelly_red").toArray();
		...
		tex_farmSpike = new TextureRegion[]{
				atlas.findRegion("farmSpike", 1),
				atlas.findRegion("farmSpike", 2),
				atlas.findRegion("farmSpike", 3),
				atlas.findRegion("farmSpike", 4),
				atlas.findRegion("farmSpike", 5),
				atlas.findRegion("farmSpike", 6),
				atlas.findRegion("farmSpike", 7),
		};

		tex_farmSpike_hole = new TextureRegion[]{
				atlas.findRegion("farmSpike_hole", 1),
				atlas.findRegion("farmSpike_hole", 2),
				atlas.findRegion("farmSpike_hole", 3),
				atlas.findRegion("farmSpike_hole", 4),
				atlas.findRegion("farmSpike_hole", 5),
				atlas.findRegion("farmSpike_hole", 6),
				atlas.findRegion("farmSpike_hole", 7),
		};

		tex_tutorialHand = new TextureRegion[]{
				atlas.findRegion("tutorialHand", 0),
				atlas.findRegion("tutorialHand", 1),
		};

		tex_powerOrbBall = atlas.findRegions("powerOrb_normal").toArray();

		video = new TextureRegion[101][];
		video[ID.Video.TEST] = new TextureRegion[51];
		video[ID.Video.HIT] = new TextureRegion[71];

		for (int i = 0; i < video[ID.Video.TEST].length; i++)
			video[ID.Video.TEST][i] = atlas.findRegion("videos/test/frame", i);

		for (int i = 0; i < video[ID.Video.HIT].length; i++)
			video[ID.Video.HIT][i] = atlas.findRegion("videos/hit/frame", i);
		...
		for (int i = 0; i < 4; i++) { // ONLY FOR MAINBALLS
			...
			fixtureDef_ball[i].filter.maskBits = (short) (MASK_ZERO | MASK_WALL | MASK_SPIKEWALL);
		...
		for (int i = 0; i < 4; i++) { // ONLY FOR MAINBALLS
			...
			fixtureDef_ball_passThrough[i].filter.maskBits = (short) (MASK_ZERO | MASK_WALL | MASK_SPIKEWALL);
		...
		PolygonShape shape_jellyShield = new PolygonShape();
		shape_jellyShield.setAsBox(8.5f * Main.MPP, 2 * Main.MPP, new Vector2(0, (-Jelly_Red.DIST_SHIELD - 2) * Main.MPP), 0);
		fixtureDef_jellyShield = new FixtureDef();
		fixtureDef_jellyShield.density = 1;
		fixtureDef_jellyShield.restitution = 1;
		fixtureDef_jellyShield.shape = shape_jellyShield;
		fixtureDef_jellyShield.filter.maskBits = MASK_ZERO;
		fixtureDef_jellyShield.filter.categoryBits = MASK_ZERO;
		...
		EdgeShape shape_gate = new EdgeShape();
		shape_gate.set(0, 0, 1, 0);
		fixtureDef_gate = new FixtureDef();
		fixtureDef_gate.isSensor = true;
		fixtureDef_gate.shape = shape_gate;
		fixtureDef_gate.filter.maskBits = MASK_ZERO;
		fixtureDef_gate.filter.categoryBits = MASK_ZERO;
		...
		shape_spike.setRadius(Spike.RADIUS * Main.MPP);
		...
		chainShape_cage.createLoop(new float[]{0, 0, 37 * Main.MPP, 0, 44 * Main.MPP, -7 * Main.MPP, 44 * Main.MPP, -28 * Main.MPP, 56 * Main.MPP, -28 * Main.MPP, 56 * Main.MPP, -7 * Main.MPP, 63 * Main.MPP, 0, 100 * Main.MPP, 0, 100 * Main.MPP, 100 * Main.MPP, 0, 100 * Main.MPP});
		fixtureDef_cage.shape = chainShape_cage;
		fixtureDef_cage.density = 1;
		fixtureDef_cage.restitution = 0;
		fixtureDef_cage.friction = 0;
		fixtureDef_cage.filter.maskBits = MASK_ZERO;
		fixtureDef_cage.filter.categoryBits = MASK_ZERO;

		fixtureDef_cage_corner_0 = new FixtureDef();
		CircleShape circleShape0 = new CircleShape();
		circleShape0.setRadius(7 * Main.MPP);
		circleShape0.setPosition(new Vector2(37 * Main.MPP, -7 * Main.MPP));
		fixtureDef_cage_corner_0.shape = circleShape0;
		fixtureDef_cage_corner_0.density = 1;
		fixtureDef_cage_corner_0.restitution = 0;
		fixtureDef_cage_corner_0.friction = 0;
		fixtureDef_cage_corner_0.filter.maskBits = MASK_ZERO;
		fixtureDef_cage_corner_0.filter.categoryBits = MASK_ZERO;

		fixtureDef_cage_corner_1 = new FixtureDef();
		CircleShape circleShape1 = new CircleShape();
		circleShape1.setRadius(7 * Main.MPP);
		circleShape1.setPosition(new Vector2(63 * Main.MPP, -7 * Main.MPP));
		fixtureDef_cage_corner_1.shape = circleShape1;
		fixtureDef_cage_corner_1.density = 1;
		fixtureDef_cage_corner_1.restitution = 0;
		fixtureDef_cage_corner_1.friction = 0;
		fixtureDef_cage_corner_1.filter.maskBits = MASK_ZERO;
		fixtureDef_cage_corner_1.filter.categoryBits = MASK_ZERO;

		PolygonShape shape_spikeWall_lower = new PolygonShape();
		shape_spikeWall_lower.set(new float[]{0, -5 * Main.MPP, 108 * Main.MPP, -5 * Main.MPP, 108 * Main.MPP, -192 * Main.MPP, 0, -192 * Main.MPP});
		fixtureDef_spikeWall_lower = new FixtureDef();
		fixtureDef_spikeWall_lower.shape = shape_spikeWall_lower;
		fixtureDef_spikeWall_lower.density = 1;
		fixtureDef_spikeWall_lower.restitution = .3f;
		fixtureDef_spikeWall_lower.friction = 0;
		fixtureDef_spikeWall_lower.filter.maskBits = (short) (MASK_ZERO | MASK_SPIKEWALL);
		fixtureDef_spikeWall_lower.filter.categoryBits = MASK_SPIKEWALL;

		PolygonShape shape_spikeWall_upper = new PolygonShape();
		shape_spikeWall_upper.set(new float[]{0, 5 * Main.MPP, 108 * Main.MPP, 5 * Main.MPP, 108 * Main.MPP, 192 * Main.MPP, 0, 192 * Main.MPP});
		fixtureDef_spikeWall_upper = new FixtureDef();
		fixtureDef_spikeWall_upper.shape = shape_spikeWall_upper;
		fixtureDef_spikeWall_upper.density = 1;
		fixtureDef_spikeWall_upper.restitution = .3f;
		fixtureDef_spikeWall_upper.friction = 0;
		fixtureDef_spikeWall_upper.filter.maskBits = (short) (MASK_ZERO | MASK_SPIKEWALL);
		fixtureDef_spikeWall_upper.filter.categoryBits = MASK_SPIKEWALL;
		...
		palette_table[2][0] = new Color(215 / 255f, 50 / 255f, 50 / 255f, 1); // red
		palette_table[2][1] = new Color(223 / 255f, 86 / 255f, 49 / 255f, 1);
		palette_table[2][2] = new Color(223 / 255f, 86 / 255f, 49 / 255f, 1);
		palette_table[2][3] = new Color(215 / 255f, 50 / 255f, 50 / 255f, 1);
...
*/
		...
		palette_egg = new Color[][]{
				new Color[4], new Color[4], new Color[4], new Color[4], new Color[4], new Color[4], new Color[4], new Color[4], new Color[4]
		};

		palette_egg[0][0] = Color.valueOf("066853");
		palette_egg[0][1] = new Color(0 / 255f, 193 / 255f, 124 / 255f, 1);
		palette_egg[0][2] = new Color(173 / 255f, 247 / 255f, 41 / 255f, 1);
		palette_egg[0][3] = Color.WHITE;

		palette_egg[1][0] = Color.valueOf("95132f");
		palette_egg[1][1] = new Color(255 / 255f, 18 / 255f, 18 / 255f, 1);
		palette_egg[1][2] = new Color(255 / 255f, 128 / 255f, 0 / 255f, 1);
		palette_egg[1][3] = Color.WHITE;

		palette_egg[2][0] = Color.valueOf("880a3d");
		palette_egg[2][1] = new Color(236 / 255f, 1 / 255f, 96 / 255f, 1);
		palette_egg[2][2] = new Color(255 / 255f, 39 / 255f, 240 / 255f, 1);
		palette_egg[2][3] = Color.WHITE;

		palette_egg[3][0] = Color.valueOf("9d3207");
		palette_egg[3][1] = new Color(230 / 255f, 117 / 255f, 0 / 255f, 1);
		palette_egg[3][2] = new Color(240 / 255f, 231 / 255f, 26 / 255f, 1);
		palette_egg[3][3] = Color.WHITE;

		palette_egg[4][0] = Color.valueOf("158826");
		palette_egg[4][1] = new Color(0 / 255f, 193 / 255f, 83 / 255f, 1);
		palette_egg[4][2] = new Color(64 / 255f, 225 / 255f, 241 / 255f, 1);
		palette_egg[4][3] = Color.WHITE;

		palette_egg[5][0] = Color.valueOf("3502b5");
		palette_egg[5][1] = new Color(126 / 255f, 0 / 255f, 221 / 255f, 1);
		palette_egg[5][2] = new Color(222 / 255f, 21 / 255f, 255 / 255f, 1);
		palette_egg[5][3] = new Color(1, 155 / 255f, 198 / 255f, 1);

		palette_egg[6][0] = Color.valueOf("066255");
		palette_egg[6][1] = new Color(0 / 255f, 162 / 255f, 92 / 255f, 1);
		palette_egg[6][2] = new Color(0 / 255f, 255 / 255f, 0 / 255f, 1);
		palette_egg[6][3] = new Color(229 / 255f, 1, 182 / 255f, 1);

		palette_egg[7][0] = Color.valueOf("2c3568");
		palette_egg[7][1] = new Color(75 / 255f, 91 / 255f, 125 / 255f, 1);
		palette_egg[7][2] = new Color(128 / 255f, 195 / 255f, 177 / 255f, 1);
		palette_egg[7][3] = new Color(1, 1, 1, 1);

		palette_egg[8][0] = Color.valueOf("000f68");
		palette_egg[8][1] = new Color(30 / 255f, 0 / 255f, 208 / 255f, 1);
		palette_egg[8][2] = new Color(101 / 255f, 39 / 255f, 255 / 255f, 1);
		palette_egg[8][3] = new Color(137 / 255f, 162 / 255f, 255 / 255f, 1);
	...
	public static void queueAssets() {
		...
		Main.assets.load("sounds/shield.mp3", Sound.class);
		Main.assets.load("sounds/slime_death.mp3", Sound.class);
		Main.assets.load("sounds/ballBreak.mp3", Sound.class);
		Main.assets.load("sounds/whoosh_0.mp3", Sound.class);
		Main.assets.load("sounds/whoosh_1.mp3", Sound.class);
		Main.assets.load("sounds/eggCrack.mp3", Sound.class);
		Main.assets.load("sounds/shot.mp3", Sound.class);
		Main.assets.load("sounds/ballHit_soft.mp3", Sound.class);
	...
	public static void preload() {
		...
		shader_cutCircle = new ShaderProgram(Gdx.files.internal("shaders/shader_cutCircle.vert"), Gdx.files.internal("shaders/shader_cutCircle.frag"));
	}
	...
	public static void dispose() {
		...
		sound_tap.dispose();
		sound_alarm.dispose();
		sound_shield.dispose();
		sound_slime_death.dispose();
		sound_ballBreak.dispose();
		sound_whoosh_0.dispose();
		sound_whoosh_1.dispose();
		sound_eggCrack.dispose();
		sound_shot.dispose();
		sound_ballHit_soft.dispose();
		...
		shader_bend.dispose();
		shader_cutCircle.dispose();
		shader_circle.dispose();
		shader_filledCircle.dispose();
	}
	...
	public static TextureRegion getShadow(float size) {
		if (size <= 7)
			return tex_circle_7p;
		if (size <= 8)
			return tex_circle_8p;
		if (size <= 12)
			return tex_circle_12p;
		if (size <= 14)
			return tex_circle_14p;
		if (size <= 18)
			return tex_circle_18p;
		if (size <= 19)
			return tex_circle_19p;
		if (size <= 23)
			return tex_circle_23p;

		return tex_circle_28p;
	}
}
